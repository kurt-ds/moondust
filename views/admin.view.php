...
<?php
$numUsers = 100; // todo: replace with actual values from db
$numProducts = 1; // todo: replace with actual values from db
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <div class="bg-[#AEA089] px-4 py-6 sm:px-6 lg:px-8 rounded-lg">
            ...
            <p class="mt-2 flex items-baseline gap-x-2">
              <span class="text-4xl font-semibold tracking-tight text-white"><?php echo $numUsers; ?></span>
            </p>
          </div>
          <div class="bg-[#AEA089] px-4 py-6 sm:px-6 lg:px-8 rounded-lg">
            <p class="text-sm font-medium leading-6 text-white">Number of Products</p>
            <p class="mt-2 flex items-baseline gap-x-2">
              <span class="text-4xl font-semibold tracking-tight text-white"><?php echo $numProducts; ?></span>
            </p>
          </div>
          <div class="bg-[#AEA089] px-4 py-6 sm:px-6 lg:px-8 rounded-lg">
