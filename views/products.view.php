    ...
    <div class="container mx-auto">
      ...
      <?php forEach ($products as $product) { ?>
        ...
        <div class="rounded-3xl w-full h-96 overflow-hidden">
          <img class="object-cover transition-all duration-300 ease-in-out group-hover:scale-110" src="/<?php echo htmlspecialchars($product["main_image"]); ?>" alt="book thumbnail image">
        </div>
        <div class="mt-4">
