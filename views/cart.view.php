      ...
      <?php else : ?>          
        <div class="mt-12 lg:grid lg:grid-cols-12 lg:items-start lg:gap-x-12 xl:gap-x-16">
          ...
          <section aria-labelledby="summary-heading" class="mt-16 rounded-lg bg-gray-50 px-4 py-6 sm:p-6 lg:col-span-5 lg:mt-0 lg:p-8 drop-shadow-xl">
            ...
            <!-- Checkout button -->
            <div class="mt-6">
              <button type="submit" form="selected-items" class="w-full rounded-md border border-transparent bg-[#AEA089] px-4 py-3 text-base font-medium text-white shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50">Checkout</button>
            </div>
          </section>
        </div>
      <?php endif; ?>
