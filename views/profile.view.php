                    ...
                    <tbody class="divide-y divide-gray-200 border-b border-gray-200 text-sm sm:border-t">
                      <?php foreach ($order['order_items'] as $item) : ?>
                        <tr>
                          ...
                          <td class="hidden py-6 pr-8 sm:table-cell"><?php echo htmlspecialchars($item['order_quantity']); ?></td>
                          <td class="hidden py-6 pr-8 sm:table-cell">₱<?php echo htmlspecialchars($item['unit_price']); ?></td>
                          <td class="hidden py-6 pr-8 sm:table-cell">₱<?php echo htmlspecialchars($item['order_price']); ?></td>
                        </tr>
                      <?php endforeach; ?>
                    </tbody>
                  </table>
